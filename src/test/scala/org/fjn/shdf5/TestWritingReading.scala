...
class TestWritingReading  extends AssertionsForJUnit {
  ...
  val arrayOfLong:   Array[Long]   =  Array.ofDim[Long](1155000).transform(_ => rngGen.nextLong()) .toArray
  val arrayOfChar:   Array[Char]   =  Array.ofDim[Char](1155000).transform(_ => 'a').toArray
  val arrayOfBytes:  Array[Byte]   =  Array.ofDim[Byte](1155000); rngGen.nextBytes(arrayOfBytes)
